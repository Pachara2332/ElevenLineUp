...
export default function ProfileDrawer({ open, onClose, user }: Props) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-[420px] bg-white border-l border-slate-200 shadow-2xl transition-transform overflow-y-auto z-50 ${open ? "translate-x-0" : "translate-x-full"}`}
      >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <label className="cursor-pointer inline-block">
                          <div
                            className={`px-4 py-2 rounded-lg transition font-bold text-xs uppercase tracking-wider text-center ${
                              uploading
